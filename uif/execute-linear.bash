...
do
    ...
    do
        for fair in "${coeff[@]}"
        do
            CUDA_VISIBLE_DEVICES=1,0 python3.6 main.py --dataset $dataset --lmda $fair --tau $tau --seed $seed --device $device --model_type $model_type --epochs 1000
            CUDA_VISIBLE_DEVICES=1,0 python3.6 main.py --dataset $dataset --lmda $fair --tau $tau --seed $seed --mode hinge --device $device  --model_type $model_type --epochs 1000
        done
    done
done